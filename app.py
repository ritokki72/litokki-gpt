...
# 🌱 감성 키워드 입력
keyword = st.text_input("🌱 감성을 입력해주세요 (예: 아름다운 느낌, 구름, 그리움 등)")
...
# ✅ requirements.txt (최신 OpenAI 1.0.0 이상 기반)
# 아래 내용을 requirements.txt 파일에 저장하면 됩니다:
# openai>=1.0.0
# streamlit>=1.25.0
# Pillow
